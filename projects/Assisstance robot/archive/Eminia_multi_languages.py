...
class francais:
    ...
    def choices(speech):
        ...
        Noms = ['NICOLAS', 'CHEIMANNOF', 'KHADIJA', 'AITHADOUCH', 'YVAN','IVAN','YVON'
                'GAIGNEBET', 'BOUCHIKHI', 'REDA', 'FATIHA', 'ELABDLAOUI','NICOLA','RIDA']
        jobs = ['DIRECTEUR', 'RESPONSABLE LOGISTIQUE','LOGISTIQUE','RESPONSABLE DE LA LOGISTIQUE', 'RECHERCHE', 'MECATRONIQUE']
            ...
            if term0 in Noms:
                ...
                while True:
                    ...
                    if francais.there_exists(['OUI','ouais'],answer):
                        ...
                        speak(l[1] + l[0]+l[2] + "de l'EMINES  "+" son bureau se  trouve dans le bloc " + l[4]+" et voici son email qui s'affiche sur l'ecran si vous voulez le contacter ")
        ...
        elif francais.there_exists(["où suis-je exactement", "où suis-je", "où je suis ", "où je suis exactement", "localisation"],speech):
    ...
    def start():
        ...
        while True:
            if francais.there_exists(['bye','a bientot', "a toute",'non','pas vraiment','au revoir',"quitter",'fini',"c'est tout","je n'ai pas","IL N'A AUCUNE QUESTION"],speech):
                speak("au revoir !")
                break
...
while True:
    ...
    socket_send("dq,")
    say("Je me présente, Je suis EMINIA, votre robot d'assistance, réalisé dans le cadre des projets mécatroniques du deuxième année cycle d'ingénieurs à l EMINES, destiné à servir et guider les visiteurs de l'université mohammed 6 polytechnique ")
    socket_send("hide,")
    socket_send("lang,")
