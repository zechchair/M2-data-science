...
class francais:
    ...
    def choices(speech):
        ...
        Noms = ['NICOLAS', 'CHEIMANOFF', 'KHADIJA', 'AITHADOUCH', 'YVAN', 'IVAN', 'YVON','GAIGNEBET', 'BOUCHIKHI', 'REDA',
        ...
        if francais.there_exists(Noms, speech):
            ...
            term0 = " ".join(term)
            if term0 in Noms:
                if term0 in ['NICOLAS', 'CHEIMANOFF', 'NICOLA']:
                    l = l1
            ...
            if any(item in jobs for item in list2):
                while True:
                    ...
                    if francais.there_exists(['OUI', 'ouais'], n_answer):
                        speak(l[1] + l[0] + l[2] + "de l'EMINES  " + " son bureau se  trouve dans le bloc   " + l[
                            4] + " et voici son email qui s'affiche sur l'ecran si vous voulez le contacter ")
